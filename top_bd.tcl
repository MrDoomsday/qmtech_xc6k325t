...
proc create_hier_cell_subsystem_ddr3 { parentCell nameHier } {
  ...
  connect_bd_net -net vcc_dout [get_bd_pins ddr_reset_sync/aux_reset_in] [get_bd_pins ddr_reset_sync/dcm_locked] [get_bd_pins vcc/dout]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: aux_rst, and set properties
  set aux_rst [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 aux_rst ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {0} \
 ] $aux_rst
  ...
  # Create instance: mb_debug_sys_rst, and set properties
  set mb_debug_sys_rst [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 mb_debug_sys_rst ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {0} \
 ] $mb_debug_sys_rst
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_dwidth_converter_0_M_AXI [get_bd_intf_pins axi_dwidth_converter_0/M_AXI] [get_bd_intf_pins subsystem_ddr3/S_AXI]
  ...
  connect_bd_net -net mb_debug_sys_rst_dout [get_bd_pins mb_debug_sys_rst/dout] [get_bd_pins proc_sys_reset_0/mb_debug_sys_rst]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_dwidth_converter_0/s_axi_aresetn] [get_bd_pins jtag_axi_0/aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins subsystem_ddr3/user_reset_n]
